...
# RC implementation
class ConvolutionalDimensionalityReductionBlockRC(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBlockRC, self).__init__()
...
# BN + RC implementation
class ConvolutionalProcessingBlockBNAndRC(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlockBNAndRC, self).__init__()
...
# BN + RC implementation
class ConvolutionalDimensionalityReductionBlockBNAndRC(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBlockBNAndRC, self).__init__()
